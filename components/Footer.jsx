export default function Footer() {
  return (
    <div className="px-32 w-full h-96 flex justify-between items-center">
      <div>
      ...
      <div>
        ...
        <div class="w-60 m-5 flex justify-evenly items-center">
          ...
          <a href="https://github.com/rajkaranm" target="_blank">
            <i class="fa-brands fa-github text-2xl p-1"></i>
          </a>
        </div>
      </div>
    </div>
