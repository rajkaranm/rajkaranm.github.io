...
export default function Projects() {
  return (
    <div id="projects" className="p-8">
      ...
      <div
        className="w-full sm:flex sm:flex-col sm:items-center md:flex md:flex-row md:justify-evenly xl:flex xl:flex-row my-28 xl:justify-evenly xl:items-center"
        data-aos="fade-up"
      >
        <Image
          className="w-[30rem] h-[19rem] rounded-xl"
          src="https://raw.githubusercontent.com/rajkaranm/crypton/main/img/crypton.png"
          alt=""
          width="400"
          height="300"
        />
        <div className="w-[20rem] m-10">
          <h3 className="text-[2rem] font-bold">#1 Crypton</h3>
